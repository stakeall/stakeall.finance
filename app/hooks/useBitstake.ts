...
export const useBitstake = () => {
  ...
  const swapAndStake = async (indexer: string, sourceToken: string, destinationToken: string, sourceTokenAmount: string, slippage: string) => {
  ...
  const getEstimatedSwapAmount = async (sourceToken: string, destinationToken: string, swapAmount: string, slippage: string) {
